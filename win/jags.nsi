!define APP_NAME "JAGS-exgauss"
!define PUBLISHER "JAGS-exgauss"

;Name used for JAGS Exgauss module registry keys
...
!define UNINSTALL_LOG "Uninstall-exgauss"
...
Section #Default section
   ...
   WriteRegStr ${INSTDIR_REG_ROOT} "${INSTDIR_REG_KEY}" "URLInfoAbout" "https://github.com/raviselker/jags-exgauss"
...
Section "32-bit installation" Sec32
   ...
   File /r inst32\lib\JAGS\modules-${MAJOR}\exgauss*
...
Section "64-bit installation" Sec64
   ...
   !insertmacro UNINSTALL.LOG_OPEN_INSTALL
   File /r inst64\lib\JAGS\modules-${MAJOR}\exgauss*
   !insertmacro UNINSTALL.LOG_CLOSE_INSTALL
